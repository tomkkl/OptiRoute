...
router.post('/', async (req, res) => {
    const { title, start, end, recurrence , category, location, address, longitude, latitude, description, notification_time, startRecur, endRecur} = req.body;

    try {
        const event = await Event.create({ title, start, end, recurrence, category, location, address, longitude, latitude, description, notification_time, startRecur, endRecur});
